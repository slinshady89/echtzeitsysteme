...
#ref_data_file = open("/home/pses/catkin_ws/src/echtzeitsysteme/src/NeuronalNetwork/Handschrift_mnist_dataset/mnist_train_10.csv", 'r')
ref_data_file = open("/home/pses/catkin_ws/src/echtzeitsysteme/images/refSchilder/schilder_ref.csv", 'r')
...
def testBild(testFilename):
    ...
    testGray = cv2.cvtColor(testImg, cv2.COLOR_BGR2GRAY) #BGR 3 Values per Pixel (Blue, Green, Red)

    # original Bild -> in 28*28 Pixel
    testGrayResize = cv2.resize(testGray, (28,28))
    return testGrayResize

anwenden_all_values = testBild('/home/pses/catkin_ws/src/echtzeitsysteme/images/refSchilder/einfahrtverboten.png')

##### Ergebnis der Neuronalen Netzwerks
# Eingabeschicht Farbwerte(0...255) in (0.01 ... 1.0) bringen
anwenden_scaled_input = (numpy.asfarray(anwenden_all_values) / 255.0 * 0.99) + 0.01
print (anwenden_scaled_input)
...
############# DATENSATZ ZUM ANWENDEN LADEN   aus .csv  Datei 
# oeffne Datei
# Pfad   -r=readonly
# anwenden_data_file = open("Handschrift_mnist_dataset/mnist_test_10.csv", 'r')
anwenden_data_file = open("/home/pses/catkin_ws/src/echtzeitsysteme/images/testSchilder/schilder_test.csv", 'r')
...
for i in range(0,13):
    ...
    # String aufteilen in Zeilen bei dem Zeichen ','
    anwenden_all_values = anwenden_data_list[i].split(',')  #0
